...
1. The main hashtag (provided in the input data) stands on the SAME LINE as the first commentary, separated by two spaces:
   [Hashtag]  1. [Text of the first commentary]
   DO NOT put a line break between the hashtag and 1.

2. Numbered commentaries (starting from the 2nd — each on a new line):
   N. [Commentary text]
   [link to original]

3. Border (opt-out/ban) — at the very end, together with hashtags.
...
- The digest MUST end with the border/disclaimer and hashtags — if they are missing, the result is INCORRECT.

### Border / Disclaimer and Hashtags
...
Hashtags (provided in the input data) should be at the very end.
