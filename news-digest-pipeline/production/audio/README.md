...
|-----------|--------|------|------|
| **Основний (робочий, 2026)** | **edge-tts `uk-UA-OstapNeural`** | Природний нейроголос, безкоштовно, без API-ключів; запуск `uvx edge-tts` | $0 |
...
> `uvx edge-tts --voice uk-UA-OstapNeural` — природний, людський український голос безкоштовно.
...
>
> ```
> uvx edge-tts --text "Текст новини" --voice uk-UA-OstapNeural --write-media out.mp3
> ```
